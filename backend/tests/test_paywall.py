...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://peersupport-hub-1.preview.emergentagent.com').rstrip('/')
...
class TestStateCheckoutEndpoint:
    ...
    def test_checkout_creates_stripe_session_for_populated_state(self):
        ...
        response = requests.post(f"{BASE_URL}/api/checkout/state", json={
            "state_code": "FL",
            "origin_url": "https://peersupport-hub-1.preview.emergentagent.com"
        }, headers=headers)
